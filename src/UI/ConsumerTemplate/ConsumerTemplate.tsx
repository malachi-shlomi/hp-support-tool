...
const ConsumerTemplate: React.FC = () => {
    ...
    return (
        <div className='d-flex flex-column gap-4 consumer-template-page'>
            <div className='page-title text-muted'>Consumer Template</div>
            ...
            <ul className='cons-temp-notes d-flex flex-column text-secondary m-0'>
                <li>Data Lose: Agreed</li>
                <li>Customer Damage: No</li>
            </ul>
            <div className=''>
                <button className='submit-template-btn bg-primary py-2 px-5 rounded'
